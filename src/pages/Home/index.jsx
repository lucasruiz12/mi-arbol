                ...
                <div className="col-12 col-md-10 col-lg-6 col-xxl-5 d-flex align-items-start justify-content-center">
                    <div className="home-user-data w-100">
                        <div>
                            ...
                            <h2 className="home-invitation">Mitiga tu huella al 100% sembrando:</h2>
                            <h2 className="home-invitation" style={{ textDecoration: 'underline' }}><b>{Math.ceil(carbonPoints / 0.015)} árboles anuales</b></h2>
                        </div>
