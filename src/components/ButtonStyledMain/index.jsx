...
const ButtonStyledMain = ({ text, functionClick, disabled = false, type = "button" }) => {
  return (
    <StyledWrapper>
      <button type={type} disabled={disabled} onClick={() => functionClick()}>
        {text}
...
export default ButtonStyledMain;
