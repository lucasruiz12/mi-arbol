...
const ModalMoreInfo = ({ showModal, hideModal }) => {
    return (
        <Modal size="xl" backdrop={"static"} show={showModal} onHide={hideModal}>
            <Modal.Header>
            ...
            <Modal.Body className="modal-more-info-body">
                <div className="container-more-info-text">
                    <div className="container-more-info">
                        ...
                        <span className="more-info-text">Con + Raíces - Huella, logramos llevar <b>la sustentabilidad al alcance de todos.</b> La suma de pequeños esfuerzos logra cambios realmente grandes; por eso queremos que cada persona, como tú, pueda sumar en favor de un cambio positivo.</span>
                        <br />
